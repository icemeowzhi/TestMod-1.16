...
import com.example.examplemod.gui.MachineExampleGui;
import com.example.examplemod.gui.ObsidianFirstContainerScreen;
...
public class ExampleMod
{
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        LOGGER.info("registering network handler....");
    ...
    public static class RegistryEvents {
        ...
        public static void onClientSetupEvent(FMLClientSetupEvent event) {
            event.enqueueWork(() -> {
                ScreenManager.registerFactory(ContainerTypeRegistry.exampleMachineContainer.get(), MachineExampleGui::new);
